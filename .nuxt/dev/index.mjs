globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/std-env/dist/index.mjs';
import { defineEventHandler, handleCacheHeaders, createEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, toNodeListener, fetchWithEvent, lazyEventHandler, getQuery, createError } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/vue/server-renderer/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/ofetch/dist/node.mjs';
import destr from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/destr/dist/index.mjs';
import { createCall, createFetch } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/hookable/dist/index.mjs';
import { snakeCase } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/scule/dist/index.mjs';
import { hash } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/ohash/dist/index.mjs';
import { parseURL, withoutBase, joinURL, withQuery } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/ufo/dist/index.mjs';
import { createStorage } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/node_modules/radix3/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"E:/项目/DEMO/nuxt3-demo/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\项目\\DEMO\\nuxt3-demo","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"E:\\项目\\DEMO\\nuxt3-demo\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\项目\\DEMO\\nuxt3-demo\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"E:\\项目\\DEMO\\nuxt3-demo\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_2YF9E0 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_2YF9E0, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2YF9E0, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://E:/%E9%A1%B9%E7%9B%AE/DEMO/nuxt3-demo/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<title>My App</title>\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"description\" content=\"My amazing site.\">\n<meta name=\"keywords\" content=\"nuxt模板,naive模板\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
